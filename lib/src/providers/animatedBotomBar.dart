import 'dart:async';
import 'package:easybuy_frontend/src/pages/HomeDesing.dart';
import 'package:easybuy_frontend/src/pages/offer_page.dart';
import 'package:easybuy_frontend/src/pages/profilePage.dart';
...
class _FancyBottomBarPageState extends State<FancyBottomBarPage> {
 ...
 // Color iconColorHome = Colors.white, iconColorCamera = Colors.white, iconColorPerson = Colors.white;
            ...
            return FancyBottomNavigation(
              ...
              items: <FancyBottomNavigationItem>[
                FancyBottomNavigationItem(
                    icon: Icon(Icons.home,), title: Text('Home',style: TextStyle(
                      //  color: Colors.white, //.fromRGBO(20, 116, 227, 1),
                        // fontWeight: FontWeight.bold,
                      ),)), 

                FancyBottomNavigationItem(
                        icon: Icon(Icons.camera_alt, ), title: Text('Product',style: TextStyle(
                        // color: Colors.white, //.fromRGBO(20, 116, 227, 1),
                        // fontWeight: FontWeight.bold,
                      ),)), 

                FancyBottomNavigationItem(
                  icon: Icon(Icons.person,), title: Text('Profile',style: TextStyle(
                   // color: Colors.white, //.fromRGBO(20, 116, 227, 1),
                   // fontWeight: FontWeight.bold,
                  ),)), 
              ],
